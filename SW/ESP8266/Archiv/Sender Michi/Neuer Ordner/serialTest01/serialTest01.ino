...
String value = "222°";
      myMqtt.publish("/client2/Temp", value);
       delay(100);
value = "7.25 g/m3";
myMqtt.publish("/client2/Feuchte",value);
 delay(100);

value = "14279 ppm";
     myMqtt.publish("/client2/C02",value );
 delay(100);

value = "20038 ppb";
     myMqtt.publish("/client2/VOC",value );
 delay(100);
value = "3.24V";
      myMqtt.publish("/client2/AD0",value );
